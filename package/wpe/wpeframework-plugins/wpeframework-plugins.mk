...
ifneq ($(BR2_PACKAGE_NEXUS_SAGE_PATH),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_SAGE_PATH="$(call qstrip,$(BR2_PACKAGE_NEXUS_SAGE_PATH))"
endif
ifneq ($(BR2_PACKAGE_NEXUS_PAK_PATH),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_PAK_PATH="$(call qstrip,$(BR2_PACKAGE_NEXUS_PAK_PATH))"
endif
ifneq ($(BR2_PACKAGE_NEXUS_DRM_PATH),)
WPEFRAMEWORK_PLUGINS_CONF_OPTS += -DPLUGIN_COMPOSITOR_DRM_PATH="$(call qstrip,$(BR2_PACKAGE_NEXUS_DRM_PATH))"
endif
